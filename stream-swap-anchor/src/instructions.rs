//! Instruction builders and invokers for StreamSwap instructions.

use crate::*;
use anchor_lang::{prelude::*, solana_program};

/// Creates and invokes a [stream_swap_client::instruction::initialize] instruction.
///
/// # Arguments
///
/// See [stream_swap_client::instruction::InitializeData].
///
...
/// Creates and invokes a [stream_swap_client::instruction::deposit] instruction.
///
/// # Arguments
///
/// See [stream_swap_client::instruction::DepositData].
///
...
/// Creates and invokes a [stream_swap_client::instruction::swap] instruction.
///
/// # Arguments
///
/// See [stream_swap_client::instruction::SwapData].
///
...
pub fn swap<'a, 'b, 'c, 'info>(
    ...
    let ix = stream_swap_client::instruction::swap(
        ctx.accounts.user.token_program.key,
        ctx.accounts.user.swap.key,
        ctx.accounts.user.swap_authority.key,
        ctx.accounts.user.user_authority.key,
...
/// Creates and invokes a [stream_swap_client::instruction::withdraw_one] instruction.
///
/// # Arguments
///
/// See [stream_swap_client::instruction::WithdrawOneData].
///
...
pub fn withdraw_one<'a, 'b, 'c, 'info>(
    ...
    let ix = stream_swap_client::instruction::withdraw_one(
        ctx.accounts.user.token_program.key,
        ctx.accounts.user.swap.key,
        ctx.accounts.user.swap_authority.key,
        ctx.accounts.user.user_authority.key,
...
/// Creates and invokes a [stream_swap_client::instruction::withdraw] instruction.
///
/// # Arguments
///
/// See [stream_swap_client::instruction::WithdrawData].
///
/// * `pool_token_amount` - Amount of LP tokens to withdraw.
...
/// Creates and invokes a [stream_swap_client::instruction::ramp_a] instruction.
///
/// # Arguments
///
/// See [stream_swap_client::instruction::RampAData].
///
...
pub fn ramp_a<'a, 'b, 'c, 'info>(
    ...
    let ix = stream_swap_client::instruction::ramp_a(
        ctx.accounts.swap.key,
        ctx.accounts.admin.key,
        target_amp,
        stop_ramp_ts,
...
/// Creates and invokes a [stream_swap_client::instruction::stop_ramp_a] instruction.
pub fn stop_ramp_a<'a, 'b, 'c, 'info>(
    ctx: CpiContext<'a, 'b, 'c, 'info, AdminUserContext<'info>>,
) -> Result<()> {
    let ix = stream_swap_client::instruction::stop_ramp_a(
        ctx.accounts.swap.key,
        ctx.accounts.admin.key,
    )?;
    solana_program::program::invoke_signed(&ix, &ctx.to_account_infos(), ctx.signer_seeds)?;
...
/// Creates and invokes a [stream_swap_client::instruction::pause] instruction.
pub fn pause<'a, 'b, 'c, 'info>(
    ctx: CpiContext<'a, 'b, 'c, 'info, AdminUserContext<'info>>,
) -> Result<()> {
    let ix = stream_swap_client::instruction::pause(ctx.accounts.swap.key, ctx.accounts.admin.key)?;
    solana_program::program::invoke_signed(&ix, &ctx.to_account_infos(), ctx.signer_seeds)?;
    Ok(())
}

/// Creates and invokes a [stream_swap_client::instruction::unpause] instruction.
pub fn unpause<'a, 'b, 'c, 'info>(
    ctx: CpiContext<'a, 'b, 'c, 'info, AdminUserContext<'info>>,
) -> Result<()> {
    let ix =
        stream_swap_client::instruction::unpause(ctx.accounts.swap.key, ctx.accounts.admin.key)?;
    solana_program::program::invoke_signed(&ix, &ctx.to_account_infos(), ctx.signer_seeds)?;
    Ok(())
}

/// Creates and invokes a [stream_swap_client::instruction::apply_new_admin] instruction.
pub fn apply_new_admin<'a, 'b, 'c, 'info>(
    ctx: CpiContext<'a, 'b, 'c, 'info, AdminUserContext<'info>>,
) -> Result<()> {
    let ix = stream_swap_client::instruction::apply_new_admin(
        ctx.accounts.swap.key,
        ctx.accounts.admin.key,
    )?;
    solana_program::program::invoke_signed(&ix, &ctx.to_account_infos(), ctx.signer_seeds)?;
...
/// Creates and invokes a [stream_swap_client::instruction::commit_new_admin] instruction
///
/// # Arguments
///
...
pub fn commit_new_admin<'a, 'b, 'c, 'info>(
    ...
    let ix = stream_swap_client::instruction::commit_new_admin(
        admin_ctx.swap.key,
        admin_ctx.admin.key,
...
/// Creates and invokes a [stream_swap_client::instruction::set_fee_account] instruction.
pub fn set_fee_account<'a, 'b, 'c, 'info>(
    ctx: CpiContext<'a, 'b, 'c, 'info, SetFeeAccount<'info>>,
) -> Result<()> {
    let ix = stream_swap_client::instruction::set_fee_account(
...
/// Creates and invokes a [stream_swap_client::instruction::set_new_fees] instruction.
///
/// # Arguments
///
/// * `fees` - new [`stream_swap_client::fees::Fees`].
pub fn set_new_fees<'a, 'b, 'c, 'info>(
    ctx: CpiContext<'a, 'b, 'c, 'info, AdminUserContext<'info>>,
    fees: stream_swap_client::fees::Fees,
) -> Result<()> {
    let ix = stream_swap_client::instruction::set_new_fees(
        ctx.accounts.swap.key,
        ctx.accounts.admin.key,
        fees,
    )?;
