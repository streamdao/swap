import type { Network, Provider } from "@streamprotocol/solana-contrib";
import {
  DEFAULT_NETWORK_CONFIG_MAP,
  SignerWallet,
} from "@streamprotocol/solana-contrib";
import type { ISeedPoolAccountsFn } from "@streamprotocol/streamswap-sdk";
import {
  DEFAULT_TOKEN_DECIMALS,
  deployNewSwap,
  RECOMMENDED_FEES,
} from "@streamprotocol/streamswap-sdk";
import type { TokenAccountData } from "@streamprotocol/token-utils";
import {
  ASSOCIATED_TOKEN_PROGRAM_ID,
  SPLToken,
  TOKEN_PROGRAM_ID,
  u64,
} from "@streamprotocol/token-utils";
  ...
  await yargs(hideBin(process.argv))
    ...
    .command(
      ...
      async ({
        ...
        const outfile =
          maybeOutfile ??
          `${os.homedir()}/streamswap_deployments/${cluster}/pool-${
