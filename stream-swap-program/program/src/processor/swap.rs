...
use stream_swap_math::curve::{StreamSwap, MAX_AMP, MIN_AMP, ZERO_TS};
use stream_swap_math::math::FeeCalculator;
...
fn process_initialize(
    ...
    let invariant = StreamSwap::new(amp_factor, amp_factor, ZERO_TS, ZERO_TS, ZERO_TS);
