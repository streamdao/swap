...
pub enum SwapInstruction {
    ...
    ///
    /// 0. `[writable, signer]` New StreamSwap to create.
    /// 1. `[]` $authority derived from `create_program_address(&[StreamSwap account])`
    /// 2. `[]` admin Account.
